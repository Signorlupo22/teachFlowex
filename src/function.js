...
///     "url": "github ulr","
/// }
function gitClone(json, currentDir) {
    exec(
        `git clone ${json.url} .`,
        { cwd: currentDir },
        (error, stdout, stderr) => {
...
///     "code": "code to insert"
/// }
function insertCode(json, currentDir) {
...
///     "code": "code to remove"
/// }
function removeCode(json, currentDir) {
...
/// }
function createFile(json, currentDir) {
...
/// }
function highlightCode(json, currentDir) {
